...
import ManualPage from '@/pages/Manuals/ManualPage.vue'
import ToolPage from '@/pages/ToolPage.vue'
import DictionaryPage from '@/pages/Dictionary/DictionaryPage.vue'
import EducationPage from '@/pages/Education/EducationPage.vue'
import HomePage from '@/pages/Homepage/HomePage.vue'
import EshopPage from '@/pages/Eshop/EshopPage.vue'
